    ...
    <footer className="bg-premium-black text-white py-16" aria-label="Site Footer">
      <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-12 flex flex-col items-center text-center">
        ...
        <div className="flex space-x-8 mb-12">
          ...
          <a href="https://www.facebook.com/yathralifestyle/" target="_blank" rel="noreferrer" aria-label="Visit our Facebook page" className="text-xs uppercase tracking-widest text-gray-400 hover:text-premium-gold transition-colors">Facebook</a>
